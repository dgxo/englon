// script is already loaded on doc load
...
document.getElementById('cool-secret-toast').addEventListener('click', () => {
   console.log('CLICKETY CLICKED');
   createToast('YOOOOOOO YOU FOUND A SECRET!', '7fec0d3f951a might help you');
});
...
function createToast(title, description) {
   ...
   toasts[0].style.translate = '0% 0px';
}
