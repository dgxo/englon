...
Game.prototype = {
   ...
   create: function () {
      ...
      new BotSnake(this.game, 'circle', -400, 400);
      new BotSnake(this.game, 'circle', -200, 90);
      new BotSnake(this.game, 'circle', 200, 300);
      new BotSnake(this.game, 'circle', 400, -300);
      new BotSnake(this.game, 'circle', 600, -600);
   ...
   snakeDestroyed: function (snake) {
      ...
      new BotSnake(this.game, 'circle', 200, -600);
   }
};
