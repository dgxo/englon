...
<body>
   ...
   <main>
      <div class="main">
         ...
         <h2>Give suggestions for new gаmes and sites in the <a class="link" href="/discord">Discord</a> or on chat!
         </h2>
         ...
         <br>
         <h3>v1.1.3</h3>
         <h4>want to crash a chromebook? click a couple times on this page
            (or go <a class="link" href="/crash">here</a>)</h4>
      </div>
   </main>
</body>
